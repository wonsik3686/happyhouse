...
CREATE TABLE `memo` (
  ...
  CONSTRAINT `memo_to_board_fk` FOREIGN KEY (`articleno`) REFERENCES `board` (`articleno`),
  CONSTRAINT `memo_to_member_fk` FOREIGN KEY (`userid`) REFERENCES `ssafy_member` (`userid`)
