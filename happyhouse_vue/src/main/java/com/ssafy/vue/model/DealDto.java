...
public class DealDto {
	...
	private String gugunCode;       // 군구 코드 
	...
	public DealDto(int type, String gugunCode, String dong, int curPage, int spp) {
		super();
		this.type = type;
	...
	public DealDto(String name, String buildYear, String dealYear, String dealMonth, String dealDay, String floor,
			String jibun, String dong, String gugunCode, String area, String deposit, String rentMoney, int type,
	...
	public String toString() {
		return "DealDto [name=" + name + ", buildYear=" + buildYear + ", dealYear=" + dealYear + ", dealMonth="
				...
				+ ", gugunCode=" + gugunCode + ", area=" + area + ", deposit=" + deposit + ", rentMoney=" + rentMoney
